...
<!--          scope.row 就是当前行数据-->
          <div class="button-group">
            <el-button type="success" v-if="!scope.row.pid" style="margin-bottom: 10px;" @click="handleAdd(scope.row)">
              添加二级分类
            </el-button>
            <el-button type="primary" style="margin-bottom: 10px;" @click="$router.push('/editCategory?id=' + scope.row.id)">
              编辑
            </el-button>
<!--            <el-button type="primary" @click="$router.push('/informCategory?id=' + scope.row.id)">-->
<!--              详情-->
<!--            </el-button>-->
